# defectdojo_openapi.FindingTemplatesApi
...
with defectdojo_openapi.ApiClient(configuration) as api_client:
    ...
    api_instance = defectdojo_openapi.FindingTemplatesApi(api_client)
    data = defectdojo_openapi.FindingTemplate() # FindingTemplate | 
