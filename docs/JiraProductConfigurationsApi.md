# defectdojo_api_swagger.JiraProductConfigurationsApi
...
api_instance = defectdojo_api_swagger.JiraProductConfigurationsApi(defectdojo_api_swagger.ApiClient(configuration))
data = defectdojo_api_swagger.JIRA() # JIRA | 
