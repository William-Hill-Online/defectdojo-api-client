...
import defectdojo_openapi.models
from defectdojo_openapi import rest
from defectdojo_openapi.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(defectdojo_openapi.models, klass)
