...
class Endpoint(object):
    ...
    def __init__(self, id=None, tags=None, protocol=None, host=None, fqdn=None, port=None, path=None, query=None, fragment=None, remediated=None, product=None, endpoint_params=None, local_vars_configuration=None):  # noqa: E501
    ...
    def fqdn(self, fqdn):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                fqdn is not None and len(fqdn) > 500):
