...
class ToolConfiguration(object):
    ...
    def __init__(self, id=None, configuration_url=None, name=None, description=None, url=None, authentication_type=None, username=None, password=None, auth_title=None, ssh=None, api_key=None, tool_type=None, local_vars_configuration=None):  # noqa: E501
    ...
    def configuration_url(self, configuration_url):
        ...
        """
        if self.local_vars_configuration.client_side_validation and configuration_url is None:  # noqa: E501
            raise ValueError("Invalid value for `configuration_url`, must not be `None`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                configuration_url is not None and len(configuration_url) < 1):
