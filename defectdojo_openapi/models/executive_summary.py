...
class ExecutiveSummary(object):
    ...
    def __init__(self, engagement_name=None, engagement_target_start=None, engagement_target_end=None, test_type_name=None, test_target_start=None, test_target_end=None, test_environment_name=None, test_strategy_ref=None, total_findings=None, local_vars_configuration=None):  # noqa: E501
        """ExecutiveSummary - a model defined in OpenAPI"""  # noqa: E501
    ...
    def engagement_name(self, engagement_name):
        ...
        """
        if self.local_vars_configuration.client_side_validation and engagement_name is None:  # noqa: E501
            raise ValueError("Invalid value for `engagement_name`, must not be `None`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                engagement_name is not None and len(engagement_name) > 200):
    ...
    def engagement_target_start(self, engagement_target_start):
        ...
        :type engagement_target_start: date
        """
        if self.local_vars_configuration.client_side_validation and engagement_target_start is None:  # noqa: E501
    ...
    def engagement_target_end(self, engagement_target_end):
        ...
        :type engagement_target_end: date
        """
        if self.local_vars_configuration.client_side_validation and engagement_target_end is None:  # noqa: E501
    ...
    def test_type_name(self, test_type_name):
        ...
        """
        if self.local_vars_configuration.client_side_validation and test_type_name is None:  # noqa: E501
            raise ValueError("Invalid value for `test_type_name`, must not be `None`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                test_type_name is not None and len(test_type_name) > 200):
            raise ValueError("Invalid value for `test_type_name`, length must be less than or equal to `200`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                test_type_name is not None and len(test_type_name) < 1):
    ...
    def test_target_start(self, test_target_start):
        ...
        :type test_target_start: datetime
        """
        if self.local_vars_configuration.client_side_validation and test_target_start is None:  # noqa: E501
    ...
    def test_target_end(self, test_target_end):
        ...
        :type test_target_end: datetime
        """
        if self.local_vars_configuration.client_side_validation and test_target_end is None:  # noqa: E501
    ...
    def test_environment_name(self, test_environment_name):
        ...
        """
        if self.local_vars_configuration.client_side_validation and test_environment_name is None:  # noqa: E501
            raise ValueError("Invalid value for `test_environment_name`, must not be `None`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                test_environment_name is not None and len(test_environment_name) > 200):
            raise ValueError("Invalid value for `test_environment_name`, length must be less than or equal to `200`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                test_environment_name is not None and len(test_environment_name) < 1):
    ...
    def test_strategy_ref(self, test_strategy_ref):
        ...
        :type test_strategy_ref: str
        """
        if self.local_vars_configuration.client_side_validation and test_strategy_ref is None:  # noqa: E501
            raise ValueError("Invalid value for `test_strategy_ref`, must not be `None`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                test_strategy_ref is not None and len(test_strategy_ref) > 200):
    ...
    def total_findings(self, total_findings):
        ...
        """
        if self.local_vars_configuration.client_side_validation and total_findings is None:  # noqa: E501
