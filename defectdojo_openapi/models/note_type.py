...
class NoteType(object):
    ...
    def __init__(self, id=None, name=None, description=None, is_single=None, is_active=None, is_mandatory=None, local_vars_configuration=None):  # noqa: E501
        """NoteType - a model defined in OpenAPI"""  # noqa: E501
