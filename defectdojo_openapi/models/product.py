...
class Product(object):
    ...
    def product_meta(self, product_meta):
        ...
        :type product_meta: list[ProductMeta]
        """
    ...
    def user_records(self, user_records):
        ...
        :type user_records: int
        """
        if (self.local_vars_configuration.client_side_validation and
                user_records is not None and user_records > 4294967295):  # noqa: E501
    ...
    def authorized_users(self, authorized_users):
        ...
        :type authorized_users: list[int]
        """
