...
class ReportGenerate(object):
    ...
    def __init__(self, executive_summary=None, product_type=None, product=None, engagement=None, report_name=None, report_info=None, test=None, endpoint=None, endpoints=None, findings=None, user=None, team_name=None, title=None, user_id=None, host=None, finding_images=None, finding_notes=None, local_vars_configuration=None):  # noqa: E501
        """ReportGenerate - a model defined in OpenAPI"""  # noqa: E501
    ...
    def executive_summary(self, executive_summary):
        ...
        :type executive_summary: ExecutiveSummary
        """
    ...
    def report_info(self, report_info):
        ...
        """
        if self.local_vars_configuration.client_side_validation and report_info is None:  # noqa: E501
            raise ValueError("Invalid value for `report_info`, must not be `None`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                report_info is not None and len(report_info) > 200):
            raise ValueError("Invalid value for `report_info`, length must be less than or equal to `200`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                report_info is not None and len(report_info) < 1):
    ...
    def finding_images(self, finding_images):
        ...
        :type finding_images: list[FindingToFindingImages]
        """
    ...
    def finding_notes(self, finding_notes):
        ...
        :type finding_notes: list[FindingToNotes]
        """
