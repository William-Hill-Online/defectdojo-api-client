...
class Scan(object):
    ...
    def __init__(self, id=None, date=None, protocol=None, status=None, baseline=None, scan_settings=None, local_vars_configuration=None):  # noqa: E501
