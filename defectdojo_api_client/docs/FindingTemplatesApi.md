# defectdojo_api_client.FindingTemplatesApi
...
with defectdojo_api_client.ApiClient(configuration) as api_client:
    ...
    api_instance = defectdojo_api_client.FindingTemplatesApi(api_client)
    data = defectdojo_api_client.FindingTemplate() # FindingTemplate | 
