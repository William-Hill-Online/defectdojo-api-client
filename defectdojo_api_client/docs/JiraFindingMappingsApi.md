# defectdojo_api_client.JiraFindingMappingsApi
...
with defectdojo_api_client.ApiClient(configuration) as api_client:
    ...
    api_instance = defectdojo_api_client.JiraFindingMappingsApi(api_client)
    data = defectdojo_api_client.JIRAIssue() # JIRAIssue | 
