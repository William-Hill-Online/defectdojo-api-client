# defectdojo_api_client.ToolConfigurationsApi
...
with defectdojo_api_client.ApiClient(configuration) as api_client:
    ...
    api_instance = defectdojo_api_client.ToolConfigurationsApi(api_client)
    data = defectdojo_api_client.ToolConfiguration() # ToolConfiguration | 
