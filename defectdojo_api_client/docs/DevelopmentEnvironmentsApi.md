# defectdojo_api_client.DevelopmentEnvironmentsApi
...
with defectdojo_api_client.ApiClient(configuration) as api_client:
    ...
    api_instance = defectdojo_api_client.DevelopmentEnvironmentsApi(api_client)
    data = defectdojo_api_client.DevelopmentEnvironment() # DevelopmentEnvironment | 
