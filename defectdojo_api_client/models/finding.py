...
class Finding(object):
    ...
    def __init__(self, id=None, images=None, tags=None, accepted_risks=None, push_to_jira=False, age=None, sla_days_remaining=None, title=None, date=None, cwe=None, cve=None, url=None, severity=None, description=None, mitigation=None, impact=None, steps_to_reproduce=None, severity_justification=None, references=None, is_template=None, active=None, verified=None, false_p=None, duplicate=None, out_of_scope=None, under_review=None, under_defect_review=None, is_mitigated=None, thread_id=None, mitigated=None, numerical_severity=None, last_reviewed=None, line_number=None, sourcefilepath=None, sourcefile=None, param=None, payload=None, hash_code=None, line=None, file_path=None, component_name=None, component_version=None, static_finding=None, dynamic_finding=None, created=None, jira_creation=None, jira_change=None, scanner_confidence=None, unique_id_from_tool=None, sast_source_object=None, sast_sink_object=None, sast_source_line=None, sast_source_file_path=None, nb_occurences=None, test=None, duplicate_finding=None, review_requested_by=None, defect_review_requested_by=None, mitigated_by=None, reporter=None, last_reviewed_by=None, sonarqube_issue=None, endpoints=None, reviewers=None, notes=None, found_by=None, local_vars_configuration=None):  # noqa: E501
    ...
    def accepted_risks(self, accepted_risks):
        ...
        :type accepted_risks: list[RiskAcceptance]
        """
