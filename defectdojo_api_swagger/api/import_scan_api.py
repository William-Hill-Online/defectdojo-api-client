...
class ImportScanApi(object):
    ...
    def import_scan_create(self, scan_type, engagement, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.import_scan_create_with_http_info(scan_type, engagement, **kwargs)  # noqa: E501
            return data
    ...
    def import_scan_create_with_http_info(self, scan_type, engagement, **kwargs):  # noqa: E501
        ...
        all_params = ['scan_type', 'engagement', 'scan_date', 'minimum_severity', 'active', 'verified', 'endpoint_to_add', 'test_type', 'file', 'lead', 'tags', 'close_old_findings', 'push_to_jira']  # noqa: E501
        ...
        if ('scan_type' not in params or
            ...
            raise ValueError("Missing the required parameter `scan_type` when calling `import_scan_create`")  # noqa: E501
        # verify the required parameter 'engagement' is set
        if ('engagement' not in params or
                params['engagement'] is None):
            raise ValueError("Missing the required parameter `engagement` when calling `import_scan_create`")  # noqa: E501

        if ('test_type' in params and
                len(params['test_type']) < 1):
            raise ValueError("Invalid value for parameter `test_type` when calling `import_scan_create`, length must be greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
        ...
        if 'test_type' in params:
            form_params.append(('test_type', params['test_type']))  # noqa: E501
        if 'file' in params:
            local_var_files['file'] = params['file']  # noqa: E501
        if 'engagement' in params:
            form_params.append(('engagement', params['engagement']))  # noqa: E501
        if 'lead' in params:
            form_params.append(('lead', params['lead']))  # noqa: E501
        if 'tags' in params:
            form_params.append(('tags', params['tags']))  # noqa: E501
            collection_formats['tags'] = 'csv'  # noqa: E501
        if 'close_old_findings' in params:
            form_params.append(('close_old_findings', params['close_old_findings']))  # noqa: E501
